    ...
    types: [
      {
        ...
        pros: ["Exterieur wassen", "Ramen en spiegels reinigen", "Spray wax aanbrengen", "Velgen"],
        cons: [
          "❌ Banden zwarten",
      ...
      },
      {
        ...
        pros: [
          ...
          "Stoomreiniging interieur globaal",
        ],
        cons: [
          "❌ Detailing",
      ...
      },
      {
        ...
        pros: [
          " In het ‘Standard Combi Pakket’ krijg je alle vinkjes van het ‘Standard Interieur en Exterieur Pakket’ gecombineerd in één pakket!",
        ],
        extras: {
          interior: [
            "Leerbehandeling (Optie: + € 50,-)",
    ...
    types: [
      ...
      },
      {
        ...
        pros: [
          ...
          "Matten uitstomen",
          "Ramen en spiegels reinigen",
          "Vlekken verwijderen / Dieptereiniging",
          "Detailing",
          "Kunststofdelen poetsen",
          "Leerbehandeling",
          "Matten stripe",
      ...
      },
      {
        ...
        pros: [
          " In het ‘Deluxe Combi Pakket’ krijg je alle vinkjes van het ‘Deluxe Interieur en Exterieur Pakket’ gecombineerd in één pakket!",
        ],
        extras: {
          interior: [
            "Honden haren verwijderen (Optie; + €50,-)",
