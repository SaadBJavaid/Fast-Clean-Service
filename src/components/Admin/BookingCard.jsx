                        ...
                        <TableBody>
                            {bookings.slice(page * rowsPerPage, page * rowsPerPage + rowsPerPage).map((booking, index) => (
                                <TableRowCustom key={index}>
                                    ...
                                    <TableCellCustom sx={{ fontSize: '1.1rem', color: 'black' }}>{booking.city}</TableCellCustom>
                                    ...
                                    <TableCellCustom sx={{ fontSize: '1.1rem', color: 'black' }}>{booking.detailing}</TableCellCustom>
