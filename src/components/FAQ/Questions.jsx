...
const questionsData = [
  {
    ...
    answer: (
      <>
        Don't worry, by looking at your car usage together we can determine which plan is the best choice for you.
        <br />
        <br />
  ...
  },
  {
    ...
    answer: (
      <>
        ...
        <br />
        <br />
        Maintaining your own car is not possible for everyone. It takes a lot of time and energy. That is why a Cardetail Plan is
  ...
  },
  {
    ...
    answer: (
      <>
        If only it were that much of a party, but unfortunately our CarDetail Plans are being registered.\n\nBecause we first
        <br />
        <br />
        provide the car on the Plan with a deep cleaning, the maintenance is what you ultimately pay for. You can have another car
        detailed for an additional fee, to surprise your girlfriend this time 😉",
      </>
    ),
  },
  {
    ...
    answer: (
      <>
        ...
        <br />
        <br />
        We will change the license plate that is registered with us and will maintain the new car from now on.
      </>
    ),
  },
  {
    ...
    answer: (
      <>
        ...
        <br />
        <br />
        We will note your permanent address, so if we need to be somewhere else on the cleaning day, please let us know.
      </>
    ),
  },
  {
    ...
    answer: (
      <>
        An email I hope I will never receive. But before cancelling, send us an email with the reason for leaving.
        <br />
        <br />
        Because it can be cancelled monthly, you are not committed to anything, but we would like to know what the reason was for
        you, so that we can work on that in the future.
      </>
    ),
  },
];
      ...
      <List sx={{width: "100%"}}>
        {questionsData.map((item, index) => (
          <ListItem
            ...
            sx={{ borderBottom: "1px solid #ddd", padding: "24px 32px", cursor: "pointer" }}
          >
            <Box sx={{ flex: 1 }}>
              ...
              <Collapse in={index in openIndex}>
                <Typography variant="h5" sx={{ marginTop: "2rem", color: '#333', fontSize: FontSizes.FAQ.answer }}>
                  {item.answer}
                </Typography>
              </Collapse>
            </Box>
