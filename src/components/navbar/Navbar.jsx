  ...
  return (
    <NavbarContainer>
      ...
      >
        ...
        <Box sx={{ position: "relative" }}>
          <Button
            ...
            endIcon={
              <ArrowDropDownIcon sx={{ marginLeft: "0.5rem", color: "#FFF" }} />
            }
            sx={{
              boxShadow: "none",
              color: "#FFF",
      ...
      <NavLinksContainer>
        ...
        <Box
          sx={{
            marginLeft: { xs: "1rem", sm: "2rem", md: "3rem", xl: "11.4rem" },
            display: "flex",
            alignItems: "center",
            gap: { xs: "2rem", sm: "2rem", md: "2rem", xl: "4rem" },
            marginRight: { xs: "1rem", sm: "2rem", xl: "4rem" },
          }}
        >
          <IconButton
