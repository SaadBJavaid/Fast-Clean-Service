  ...
  return (
      <Card
          ...
          sx={{
            ...
            flex: "1 1 30%",  // Adjust flex basis for responsive resizing
            maxWidth: "calc(33% - 1rem)",
            minHeight: "500px",
            backgroundColor: card?.options ? "" : "#cbcbcb80",
            '@media (max-width: 900px)': {
              flex: '1 1 45%', // Adjust to fit two boxes per row
            },
            '@media (max-width: 600px)': {
              flex: '1 1 90%', // Adjust to fit one box per row
            }
          }}
      >
          ...
          <HomePkgsInBox sx={{ justifyContent: "center", alignSelf: "center" }}>
            <CardContainer
                sx={{
                  gap: "2rem",
                  opacity: subCat ? 1 : 0,
                  flexWrap: 'wrap', // Ensures cards wrap in smaller screens
                }}
            >
              <ModdedCard
                  card={{
