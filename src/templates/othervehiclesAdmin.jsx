...
const OtherVehiclesAdminEmail = ({ name, businessName, email, phone, vehicleType, serviceType, location, address, numVehicles }) => {
            ...
            <Body style={main}>
                <Container style={container}>
                    ...
                    <Text style={paragraph}>
                        A new service request has been submitted for other vehicles. Here are the details:
                    </Text>
                    <Section style={bookingDetails}>
                        ...
                        <Text style={detailText}><strong>Vehicle Type:</strong> {vehicleType}</Text>
                        ...
                        <Text style={detailText}><strong>Number of Vehicles:</strong> {numVehicles}</Text>
                    </Section>
                    <Text style={paragraph}>
                        Please review this request and coordinate with the client if necessary.
                    </Text>
