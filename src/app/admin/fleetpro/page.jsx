...
export default function FleetProCareAppointments() {
  const [data, setData] = useState([
    ...
    },
    {
      ...
      address: "321 Pine St",
      name: "Eve Green",
      email: "eve@globallog.com",
      vehicleType: "Truck",
      fleetSize: "51-100",
    },
    {
      business: "Fast Track Inc.",
      address: "654 Maple St",
      name: "Kevin White",
      email: "kevin@fasttrack.com",
      vehicleType: "Car",
      fleetSize: "101-500",
    },
    {
      business: "Mega Industries",
      address: "987 Elm St",
      name: "Sophia Brown",
      email: "sophia@megaindustries.com",
      vehicleType: "Van",
      fleetSize: "1-10",
    },
    {
      business: "Bright Future",
      address: "246 Cedar St",
      name: "Liam Grey",
      email: "liam@brightfuture.com",
      vehicleType: "SUV",
      fleetSize: "11-50",
    },
    {
      ...
      name: "Olivia Blue",
      email: "olivia@innovatecorp.com",
      vehicleType: "Bike",
      fleetSize: "1-10",
    },
    {
      business: "Visionary Tech",
      address: "789 Spruce St",
      name: "Mason Violet",
      email: "mason@visionary.com",
      vehicleType: "Car",
      fleetSize: "1-5",
    },
    {
    ...
    {
      business: "Pioneer Logistics",
      address: "456 Willow St",
      name: "James Gold",
      email: "james@pioneerlogistics.com",
      vehicleType: "SUV",
      fleetSize: "11-50",
    },
    {
      business: "Blue Horizon",
      address: "321 Aspen St",
      name: "Ava Red",
      email: "ava@bluehorizon.com",
      vehicleType: "Car",
      fleetSize: "51-100",
    },
    {
      business: "Prime Services",
      address: "987 Beech St",
      name: "Noah Green",
      email: "noah@primeservices.com",
      vehicleType: "Van",
      fleetSize: "101-500",
    },
    {
      business: "Eagle Enterprises",
      address: "654 Cherry St",
      name: "Lucas Indigo",
      email: "lucas@eagleent.com",
      vehicleType: "Car",
      fleetSize: "1-5",
    },
    {
      business: "Streamline Inc.",
      address: "789 Redwood St",
      name: "Isabella Orange",
      email: "isabella@streamline.com",
      vehicleType: "SUV",
      fleetSize: "6-10",
    },
    {
      business: "Unified Logistics",
      address: "456 Fir St",
      name: "Alexander Yellow",
      email: "alex@unifiedlog.com",
      vehicleType: "Truck",
      fleetSize: "11-50",
    },
    {
      business: "Dynamic Corp.",
      address: "135 Palm St",
      name: "Charlotte Pink",
      email: "charlotte@dynamiccorp.com",
      vehicleType: "Car",
      fleetSize: "51-100",
    },
    {
      business: "Skyline Enterprises",
      address: "321 Sequoia St",
      name: "Henry Bronze",
      email: "henry@skylineent.com",
      vehicleType: "SUV",
      fleetSize: "1-10",
    },
    {
      business: "Summit Solutions",
      address: "654 Poplar St",
      name: "Mia White",
      email: "mia@summitsolutions.com",
      vehicleType: "Van",
      fleetSize: "101-500",
    },
    {
      business: "Peak Performers",
      address: "987 Dogwood St",
      name: "Ethan Purple",
      email: "ethan@peakperformers.com",
      vehicleType: "Truck",
      fleetSize: "1-5",
    },
  ]);
    ...
    <Box sx={{ padding: "16px" }}>
      ...
      <Modal open={open} onClose={handleClose} aria-labelledby="add-service-modal" aria-describedby="form-to-add-service">
        <Box sx={{ display: "flex", justifyContent: "center", alignItems: "center", height: "auto" }}>
          <ModalCard sx={{ padding: "20px", position: "relative" }}>
            <IconButton onClick={handleClose} sx={{ position: "absolute", top: "10px", right: "10px" }}>
              <CloseIcon />
            </IconButton>
            <Typography variant="h6" component="h2" sx={{ fontSize: "1.6rem", marginBottom: "20px" }}>
              Add New Service
            </Typography>
